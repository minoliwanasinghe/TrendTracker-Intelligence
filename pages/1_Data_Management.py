...
# 2. DESIGNED CSS WITH REPAIRED TEXT CONTRAST (NO UNDERLYING P TAG TARGETS)
st.markdown("""
    <style>
    /* Force app background color to be clean off-white */
    .stApp { 
        background-color: #fdfdfd !important; 
    }
    
    /* Clean Header Container Box without borders */
    .header-box {
